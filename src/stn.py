...
'''
CONTRACT FOR STN CLASS
Represents a Simple Temporal Network. Consists of a constructor and methods
implementing the Dijkstra and Johnson's algorithms.
CLASS FIELDS
...
3) length => number of nodes in the STN.
'''
...
class STN:
    ...
    INPUT
    src => A node that already exists in the STN.
    OUTPUT
    ...
    INPUT
    src => An arbitrary node that does not exist in the STN.
    OUTPUT
